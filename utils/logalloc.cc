...
using segment_descriptor_hist_options = log_histogram_options<max_managed_object_size_shift, 3, segment::size_shift>;
...
public:
    ...
    virtual ~region_impl() {
        ...
        while (!_segment_descs.empty()) {
            auto& desc = _segment_descs.one_of_smallest();
            _segment_descs.pop_one_of_smallest();
    ...
    occupancy_stats min_occupancy() const {
        ...
        return _segment_descs.smallest().occupancy();
    }
    ...
    void full_compaction() {
        ...
        _closed_occupancy = {};
        while (!all.empty()) {
            auto& desc = all.one_of_smallest();
            all.pop_one_of_smallest();
