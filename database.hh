...
private:
    void update_stats_for_new_sstable(uint64_t disk_space_used_by_sstable, const std::vector<unsigned>& shards_for_the_sstable);
    // Adds new sstable to the set of sstables
    // Doesn't update the cache.
    // Doesn't trigger compaction.
    void add_sstable(lw_shared_ptr<sstables::sstable> sstable, const std::vector<unsigned>& shards_for_the_sstable);
