...
public:
    ...
    mutation_reader make_reader(schema_ptr schema,
            ...
            tracing::trace_state_ptr trace_state = tracing::trace_state_ptr()) const;
...
public:
    ...
    future<lw_shared_ptr<query::result>> query(schema_ptr, const query::read_command& cmd, query::result_request request, const std::vector<query::partition_range>& ranges, tracing::trace_state_ptr trace_state = tracing::trace_state_ptr());
    future<reconcilable_result> query_mutations(schema_ptr, const query::read_command& cmd, const query::partition_range& range, tracing::trace_state_ptr trace_state = tracing::trace_state_ptr());
