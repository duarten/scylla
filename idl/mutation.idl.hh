...
class range_tombstone stub [[writable]] {
    ...
    tombstone tomb;
    bound_kind start_kind [[version 1.12]] = bound_kind::incl_start;
    clustering_key_prefix end [[version 1.12]] = start;
    bound_kind end_kind [[version 1.12]] = bound_kind::incl_end;
};
