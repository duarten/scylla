...
class build_progress_virtual_reader {
    ...
    struct build_progress_reader : flat_mutation_reader::impl {
        ...
        build_progress_reader(schema_ptr schema, flat_mutation_reader underlying)
                ...
                , _scylla_next_token_col(underlying_schema().get_column_definition("next_token")->id)
                , _scylla_generation_number_col(underlying_schema().get_column_definition("generation_number")->id)
