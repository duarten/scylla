...
public:
    ...
    future<> notify_create_view(const schema_ptr& view);
    ...
    future<> notify_update_view(const schema_ptr& view, bool columns_changed);
    ...
    future<> notify_drop_view(const schema_ptr& view);
    ...
    future<> announce_new_view(schema_ptr view, bool announce_locally = false);

    future<> announce_view_update(schema_ptr view, bool announce_locally = false);
