...
future<> storage_proxy::send_to_endpoint(mutation m, gms::inet_address target) {
    return mutate_prepare(std::array<mutation, 1>{std::move(m)}, db::consistency_level::ONE, db::write_type::VIEW,
